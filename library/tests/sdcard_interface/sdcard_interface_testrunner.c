...
TEST_GROUP_RUNNER(sdcard_interface)
{
	...
	RUN_TEST_CASE(sdcard_interface,	ReadEvent_with_offset_for_N_FROM_BEGINING_reading_100_values_at_a_time_until_the_end_of_log_is_possible);
	
	RUN_TEST_CASE(sdcard_interface,	GetEventCount_returns_error_if_filename_is_NULL);
	RUN_TEST_CASE(sdcard_interface,	GetEventCount_returns_error_if_file_is_not_available);
	RUN_TEST_CASE(sdcard_interface,	GetEventCount_returns_error_if_count_argument_is_NULL);
	RUN_TEST_CASE(sdcard_interface,	GetEventCount_returns_success_and_count_is_properly_updated);
